...
const CreateDrinks = () => {
    ...
    const handleUpdateSubmit = async () => {
      ...
      try {
        const response = await axios.put(
          `${baseUrl}/api/drink/updateDrinks`,
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
    ...
    const handleDeleteItem = async (itemId) => {
      try {
        await axios.delete(`${baseUrl}/api/drink/deleteDrinks`, {
          data: { id: itemId },
        });
          ...
          {activeItem === "Add Items" && (
            ...
            >
              ...
              <div className="flex xs:flex-col gap-8 xs:w-full md:w-[50%] xs:items-center pt-[30px] md:justify-start">
                ...
                >
                  {loading ? "Creating..." : "Create Drinks Item"} {/* Change button text based on loading state */}
                </button>
              </div>
            </form>
          )}
